...
function getProjectionDescription() {
  ...
  /*
   * Function getProjectionDescription
   * Returns a string representation of the projection type
   */
...
function projectInclination(inc) {
  ...
  // The inclination value can be treated as being absolute since the
...
function hemispherePlot(id, distribution) {
  ...
  // Enable the Deenen et al., 2011 criteria
